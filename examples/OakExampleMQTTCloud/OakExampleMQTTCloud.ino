/*
   ...
   - publish the data wirelessly to the Particle.io cloud
    ...
    case 30:
      ...
      */
      if (cotwo && cotwo < maxCO2 && ( abs(cotwo - prefCotwo) >= 5)) {
        ...
        // Publish to cloud
        Particle.publish("Temperature", outstr);
        dtostrf( ((int)hum - humOffset), sizeof(hum), 0, outstr);  // convert humidity value to string, applying offset
        Particle.publish("Humidity", outstr);
